...
//     // Step 2: Fetch matching memories from DB
//     const memoryRecords = await prismaClient.memory.findMany({
//       where: {
//         id: { in: ids },
//         userId: user.id,
...
//     // Step 3: Mistral chat completion
//     const response = await mistral.chat.complete({
//       model: "mistral-small-latest",
//       messages: [{ role: "user", content: prompt }],
//     });
...
//     return c.json({ success: false, message: "Internal Server Error", error: String(err) }, 500);
//   }
// });
